...
// Automatize Já Branding Icons
export const AutomatizeJaIcon = ({ size = 24 }: { size?: number }) => {
  return (
    <svg
      height={size}
      viewBox="0 0 48 48"
    ...
    >
      <path
        d="M12 36L24 12L36 24L24 36L12 36Z"
        fill="none"
        stroke="currentColor"
        strokeLinecap="round"
        strokeLinejoin="round"
...
export const AutomatizeJaIconFilled = ({ size = 24 }: { size?: number }) => {
  return (
    <svg
      height={size}
      viewBox="0 0 48 48"
    ...
    >
      <path
        d="M8 40L22 8L44 20L22 40H8Z"
        fill="currentColor"
      />
      <path
        d="M32 14L42 6L46 10L38 20"
        fill="currentColor"
      />
    </svg>
  );
    ...
    <div className="flex items-center gap-2">
      ...
      {showText && (
        <span className="font-sans font-semibold text-lg tracking-tight">
          Automatize<span className="font-serif italic">Já</span>
        </span>
      )}
    </div>
  );
